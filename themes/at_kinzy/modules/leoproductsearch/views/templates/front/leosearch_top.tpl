	...
	<form method="get" action="{$link->getPageLink('productsearch', true)|escape:'html':'UTF-8'}" id="leosearchtopbox">
		...
		<div class="block_content clearfix leoproductsearch-content">		
			...
			<div class="leoproductsearch-result">
				...
				<input class="search_query form-control grey" type="text" id="leo_search_query_top" name="search_query" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" placeholder="{l s='Ieškoti mūsų kataloge' d='Shop.Theme.Global'}" />
