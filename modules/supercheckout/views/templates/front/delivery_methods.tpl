                ...
                <li class="highlight">
                    ...
                    {elseif isset($terminals) && !empty($terminals)}
                        ...
                        <div class="lp_carrier col-12" data-carrier-id="{$id_carrier}" style="overflow: hidden;{if $carrier.id|intval == "47"}display: block; {else}display: none;{/if}">
                            <select class="select2-hidden-accessible" id="lp_express_terminal" tabindex="-1" aria-hidden="true" style="box-sizing: border-box; width: auto; max-width: 100%;">
                            ...
                            <span class="select2 select2-container select2-container--default select2-container--below" dir="ltr" style="width: 421px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-lp_express_terminal-container"><span class="select2-selection__rendered" id="select2-lp_express_terminal-container" title="Pašto skyrius Laisvės g. 1, Kalvarija">Pašto skyrius Laisvės g. 1, Kalvarija</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div>
                    {/if}
                                    </li>
